...
<table>
  ...
  <tr style="height:auto;">
    <td>
      <p style="width:240px;padding: 10px 20px;border-bottom: 2px solid #888888;margin-top: 20px;font-size: 1.3em;">Authorization Request</p>
      <p style="margin: 20px 25px;font-size: 1.1em;">Hi {{ $customer_name }},<br> Please check your project details on our system. Here is the Customer login.</p>
