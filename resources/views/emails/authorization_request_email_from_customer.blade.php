...
<table >
  ...
  <tr style="height:auto;">
    <td>
      <p style="width:240px;padding: 10px 20px;border-bottom: 2px solid #888888;margin-top: 20px;font-size: 1.3em;">{{
      $title }}</p>
      <p style="margin: 20px 25px;font-size: 1.1em;">Dear {{ $user_name }},<br>{!! $body !!} {{
      $project_name }}</p>
