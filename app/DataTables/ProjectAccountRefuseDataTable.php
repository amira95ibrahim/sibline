...
class ProjectAccountRefuseDataTable extends DataTable
{
    ...
    {
        return $model->where(['project_id'=>$this->project_id ,'authorization_status'=> 4])->with(['project'])->newQuery();
    ...
    public function html()
    {
        ...
        return $this->builder()
        ->setTableId('project-refuse-accounts-table')
